...
def handle_streaming_response(text, current_user):
    ...
    try:
        ...
        try:
            ...
            if CONSCIOUSNESS_ARCHITECTURE_AVAILABLE and consciousness_available:
        ...
        try:
            ...
            if speech_result:
                ...
                try:
                    ...
                    print("[FullDuplex] ✅ Response complete, ready for next user input")
                    
                except Exception as e:
                    print(f"[FullDuplex] ADVANCED AI streaming response error: {e}")
                    speak_streaming("Sorry, I had a problem generating a response.")
                    
                    # ✅ CRITICAL FIX: Reset state even on error
                    if full_duplex_manager:
                        full_duplex_manager.force_reset_to_waiting()
                        print("[FullDuplex] 🔄 State: RESET TO WAITING_FOR_INPUT (after error)")
